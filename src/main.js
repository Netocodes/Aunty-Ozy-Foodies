    ...
    soups.forEach(soup => {
        ...
        <div class="flex-none w-64 snap-center">
				<div class="bg-white border-1 border border-gray-200 rounded-lg overflow-hidden mb-4">
					<img src="${soup.image}" alt="Product Image" class="w-full h-40 object-cover shadow-md">
					<div class="p-4">
						...
						<div class="flex justify-between items-center mt-4">
							...
							<a href="${soup.link}" target="_blank"
								class="flex gap-x-2 text-white w-full main-color focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"><svg
...
const initRice = async () => {
    ...
    Rice.forEach(rice => {
        ...
        <div class="flex-none w-64 snap-center">
				<div class="bg-white border-1 border border-gray-200 rounded-lg overflow-hidden mb-4">
					<img src="${rice.image}" alt="Product Image" class="w-full h-40 object-cover shadow-md">
					<div class="p-4">
						...
						<div class="w-full flex justify-center items-center mt-4">
							...
							<a href="${rice.link}" target="_blank"
								class="flex w-full gap-x-2 text-white main-color focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"><svg
									xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
									stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
									<path stroke-linecap="round" stroke-linejoin="round"
										d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
...
const initProtien = async () => {
    ...
    proteins.forEach(protien => {
        ...
        <div class="flex-none w-64 snap-center">
				<div class="bg-white border-1 border border-gray-200 rounded-lg overflow-hidden mb-4">
					<img src="${protien.image}" alt="Product Image" class="w-full h-40 object-cover shadow-md">
					<div class="p-4">
